...
// });
//Exporting module
console.log("Exporting module");const l=[];var s=/**
 * @license
 ...
 */function(t){return E(t)?na(t,!0):oy(t)},ob=c("gqoYg"),om=nl(Object.getPrototypeOf,Object),oj=Object.getOwnPropertySymbols?function(t){for(var n=[];t;)V(n,t5(t)),t=om(t);return n}:t8,ow=/**
 ...
 */function(t){return z(t)&&"[object Map]"==nB(t)},ne=c("lFXqE"),oF=ne.default&&ne.default.isSet,oP=oF?tz(oF):/**
 ...
 */function(t){return function(n,r){return"string"==typeof n&&"string"==typeof r||(n=q(n),r=q(r)),t(n,r)}},oZ=oK(o$),oV=oK(function(t,n){return t>=n}),ne=c("lFXqE"),oG=ne.default&&ne.default.isArrayBuffer,oX=oG?tz(oG):/**
 ...
 * _.isError(Error);
 * // => false
 */function(t){if(!z(t))return!1;var n=w(t);return"[object Error]"==n||"[object DOMException]"==n||"string"==typeof t.message&&"string"==typeof t.name&&!o2(t)},h=c("2mpFt"),o4=h.default.isFinite,o8=/**
 ...
 * // => { 'a': 1, 'c': 3 }
 */function(t,n){if(null==t)return{};var r=tB(ow(t),function(t){return[t]});return n=ri(n),av(t,r,function(t,r){return n(t,r[0])})},ag=rU(function(t,n){return null==t?{}:av(t,n,function(n,r){return rt(t,r)})}),nn=c("f3ZL4"),ay=/**
 ...
 */function(){var t=this.__wrapped__.value(),n=this.__dir__,r=Q(t),e=n<0,i=r?t.length:0,o=f8(0,i,this.__views__),u=o.start,a=o.end,f=a-u,c=e?a:u-1,l=this.__iteratees__,s=l.length,p=0,h=f6(f,this.__takeCount__);if(!r||!e&&i==f&&h==f)return aw(t,this.__actions__);var v=[];t:for(;f--&&p<h;){for(var d=-1,g=t[c+=n];++d<s;){var y=l[d],_=y.iteratee,b=y.type,m=_(g);if(2==b)g=m;else if(!m){if(1==b)continue t;break t}}v[p++]=g}return v},iB.prototype.at=ax.at,iB.prototype.chain=ax.wrapperChain,iB.prototype.commit=ax.commit,iB.prototype.next=ax.next,iB.prototype.plant=ax.plant,iB.prototype.reverse=ax.reverse,iB.prototype.toJSON=iB.prototype.valueOf=iB.prototype.value=ax.value,iB.prototype.first=iB.prototype.head,ct&&(iB.prototype[ct]=ax.toIterator),l.push({product:o="pizza",quantity:2}),console.log({quantity:2,product:o}),// Not empty, import is not simply a copy of the value we exported, it is a live connection
console.log(l);const ci={cart:[{product:"bread",quantity:5}],user:{loggedIn:!0}},co=Object.assign({},ci),cu=iB(ci);ci.user.loggedIn=!1,//It is false too now in the clone
console.log(co),//true in the deep clone, not changed
console.log(cu);//# sourceMappingURL=index.82d6ee39.js.map

//# sourceMappingURL=index.82d6ee39.js.map
